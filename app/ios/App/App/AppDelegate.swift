...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    // A notice was tapped (a finished download, a ready reply, a desktop
    // session). Hand its payload to the web layer, which opens the thing the
    // notice is about.
    func userNotificationCenter(
        _ center: UNUserNotificationCenter,
        ...
        OscodeLlamaPlugin.deliverNoticeTap(response.notification.request.content.userInfo)
        completionHandler()
    }
