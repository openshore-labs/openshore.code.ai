...
const HARBOR_MINI_PERSONA = [
  ...
  '- A real coding agent that edits their repositories: get Harbor Master, the most capable Harbor, on their own computer, then pair this phone to it.',
  ...
  '',
  'Get Harbor Master (on their computer):',
