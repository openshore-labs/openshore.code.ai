...
// actually look things up instead of guessing. Harbor Lite (harborMini.ts)
...
function harborPersona(searchable: boolean): string {
  return [
    ...
    searchable
      ? 'You are bigger and more capable than the smaller Harbor Lite guide: real reasoning, and real web search when you need current information.'
      : 'You are bigger and more capable than the smaller Harbor Lite guide: real reasoning.',
