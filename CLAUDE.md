...
works. Refresh the snapshot deliberately by reading the live page again; never
wire it to a live fetch, since the page is world-editable. Scope is this repo
for now, as the single source of truth.
